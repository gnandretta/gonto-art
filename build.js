...
var _user$project$GontoArt$positions = A2(
	...
	function (i) {
		return A2(
			...
			_elm_lang$core$Native_List.range(0, _user$project$GontoArt$colCount - 1));
	},
	_elm_lang$core$Native_List.range(0, _user$project$GontoArt$rowCount - 1));
var _user$project$GontoArt$textOutput = function (onPositions) {
	var cellText = F2(
		function (i, j) {
			return A2(
				_elm_lang$core$Set$member,
...
var _user$project$GontoArt$copyButton = function (onPositions) {
	return A2(
		...
		return _elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_user$project$GontoArt$cellLength),
						'px')
				},
					{
					ctor: '_Tuple2',
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(j * (_user$project$GontoArt$cellLength + 1)),
						'px')
				},
					{
					ctor: '_Tuple2',
...
var _user$project$GontoArt$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				onPositions: A2(_user$project$GontoArt$togglePosition, _p0._0, model.onPositions)
			});
	});
var _user$project$GontoArt$Model = function (a) {
	return {onPositions: a};
};
var _user$project$GontoArt$model = _user$project$GontoArt$Model(_elm_lang$core$Set$empty);
var _user$project$GontoArt$TogglePosition = function (a) {
	return {ctor: 'TogglePosition', _0: a};
};
var _user$project$GontoArt$cell = F3(
	function (i, j, onPositions) {
		return A2(
...
var _user$project$GontoArt$rows = function (onPositions) {
	return A2(
		_elm_lang$core$List$map,
		function (_p1) {
			var _p2 = _p1;
			return A3(_user$project$GontoArt$cell, _p2._0, _p2._1, onPositions);
		},
		_user$project$GontoArt$positions);
};
var _user$project$GontoArt$box = function (onPositions) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$GontoArt$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$GontoArt$model, view: _user$project$GontoArt$view, update: _user$project$GontoArt$update})
};

var Elm = {};
Elm['GontoArt'] = Elm['GontoArt'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GontoArt'], 'GontoArt', typeof _user$project$GontoArt$main === 'undefined' ? null : _user$project$GontoArt$main);
